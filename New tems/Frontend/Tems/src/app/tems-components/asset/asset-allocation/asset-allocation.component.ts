...
export class AssetAllocationComponent extends TEMSComponent implements OnInit {
  ...
  @ViewChild('assetIdentifierChips') assetIdentifierChips: ChipsAutocompleteComponent;
  @ViewChild('allocatedTo') allocatedTo: ChipsAutocompleteComponent;

  assetAlreadySelectedOptions = [] as IOption[];
  ...
  assetAllocationFormGroup: FormGroup;
  dialogRef;
  ...
  ngOnInit(): void {
    ...
    if (this.equipment != undefined)
      this.assetAlreadySelectedOptions = this.equipment;
    ...
    this.assetAllocationFormGroup = new FormGroup({
      equipment: new FormControl(this.assetAlreadySelectedOptions, Validators.required),
  ...
  onSelection() {
    switch (this.assetAllocationFormGroup.controls.allocateToType.value) {
      case 'room':
        this.allocatedToChipsInputLabel = this.translate.instant('form.hints.Room identifier');
        this.alocateeEndPoint = this.roomService;
        break;
    ...
    this.assetAllocationFormGroup.controls.allocateTo.setValue([] as IOption[]);
  ...
  clearModel(){
    this.assetIdentifierChips.selectOptions = [];
    this.allocatedTo.selectOptions = [];
  }
}
