...
@Component({
  selector: 'app-asset-allocation-container',
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
  ...
  templateUrl: './asset-allocation-container.component.html',
  styleUrls: ['./asset-allocation-container.component.scss']
})
export class AssetAllocationContainerComponent extends TEMSComponent implements OnInit {
