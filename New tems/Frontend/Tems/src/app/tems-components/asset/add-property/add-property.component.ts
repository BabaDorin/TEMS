...
import { AddProperty } from './../../../models/asset/add-property.model';
...
export class AddPropertyComponent extends TEMSComponent implements OnInit {
  ...
  onSubmit(){
    ...
    let endPoint = this.assetService.addProperty(addProperty);
    if(addProperty.id != undefined)
      endPoint = this.assetService.updateProperty(addProperty);
