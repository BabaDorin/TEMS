...
import { Component, ElementRef, EventEmitter, forwardRef, Input, OnChanges, OnInit, Output, SimpleChange, ViewChild, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
export class ChipsAutocompleteComponent extends FieldType implements OnInit, ControlValueAccessor, OnChanges {
  ...
  ngOnChanges(changes: { [propName: string]: SimpleChange }) {
    ...
    this.listenToServer();
    this.selectOptions = (this.alreadySelected == undefined) ? [] : this.alreadySelected;
    this.onChange(this.selectedOptions);
  }
