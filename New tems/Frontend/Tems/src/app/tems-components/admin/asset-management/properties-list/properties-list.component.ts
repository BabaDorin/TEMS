...
import { ViewPropertySimplified } from './../../../../models/asset/view-property-simplified.model';
import { IGenericContainerModel } from './../../../../models/generic-container/IGenericContainer.model';
import { AssetService } from './../../../../services/asset.service';
import { TEMSComponent } from './../../../../tems/tems.component';
import { AddPropertyComponent } from './../../../asset/add-property/add-property.component';
...
export class PropertiesListComponent extends TEMSComponent implements OnInit {
  ...
  fetchProperties(){
    this.subscriptions.push(
      this.assetService.getPropertiesSimplified()
      .subscribe(result => {
