...
import { Component, forwardRef, OnInit, Inject, Optional } from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormControl, FormGroup, NG_VALUE_ACCESSOR, Validators, FormBuilder, FormsModule, ReactiveFormsModule } from '@angular/forms';
...
import { atLeastOne } from '../../../models/validators';
...
export class CreateReportTemplateComponent extends TEMSComponent implements OnInit {
  ...
  constructor(
    ...
    @Optional() public dialogRef: MatDialogRef<CreateReportTemplateComponent>,
