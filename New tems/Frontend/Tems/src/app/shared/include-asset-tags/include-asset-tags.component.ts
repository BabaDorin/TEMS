...
@Component({
  selector: 'app-include-asset-tags',
  standalone: true,
  imports: [CommonModule, MatChipsModule, TranslateModule, MatIconModule, MatSlideToggleModule, MatTooltipModule, FormsModule],
  templateUrl: './include-asset-tags.component.html',
  styleUrls: ['./include-asset-tags.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => IncludeAssetLabelsComponent),
      multi: true
    }
  ]
})
export class IncludeAssetLabelsComponent implements OnInit, ControlValueAccessor{
