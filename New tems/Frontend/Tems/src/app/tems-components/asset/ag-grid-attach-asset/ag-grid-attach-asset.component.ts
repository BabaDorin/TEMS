...
import { AttachEquipment } from './../../../models/asset/attach-asset.model';
...
@Component({
  ...
  templateUrl: './ag-grid-attach-asset.component.html',
  styleUrls: ['./ag-grid-attach-asset.component.scss']
})
export class AgGridAttachAssetComponent extends TEMSComponent implements OnChanges {
  ...
  attach(eventData) {
    ...
    this.subscriptions.push(
      this.assetService.attach(model)
        .subscribe(result => {
