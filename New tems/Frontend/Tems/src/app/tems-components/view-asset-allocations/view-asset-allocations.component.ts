...
@Component({
  selector: 'app-view-asset-allocations',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './view-asset-allocations.component.html',
  styleUrls: ['./view-asset-allocations.component.scss']
})
export class ViewAssetAllocationsComponent implements OnInit {
