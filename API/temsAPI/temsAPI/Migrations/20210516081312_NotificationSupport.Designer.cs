...
namespace temsAPI.Migrations
{
    ...
    [Migration("20210516081312_NotificationSupport")]
    partial class NotificationSupport
    {
            ...
            modelBuilder.Entity("temsAPI.Data.Entities.UserEntities.TEMSUser", b =>
                {
                    ...
                    b.Property<string>("CommonNotificationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CommonNotificationId");
            ...
            modelBuilder.Entity("temsAPI.Data.Entities.UserEntities.TEMSUser", b =>
                {
                    ...
                    b.HasOne("temsAPI.Data.Entities.CommunicationEntities.CommonNotification", null)
                        .WithMany("SendTo")
                        .HasForeignKey("CommonNotificationId");
